...
namespace Wasm.Text
{
    ...
    public class ParserTests
    {
        ...
        public void ParseSExpressions()
        {
            ...
            Assert.IsFalse(exprWithoutTail.HasTail);
